...
export class Control {
  ...
  constructor(public editor: Editor, public block: Block) {
    ...
    this.expandHandle.classList.add('editor-control__expand-handle')
    ...
    // this.dashboard.style.maxHeight = null;
    this.dashboard.classList.add('editor-control__dashboard')

    this.dashboard.appendChild(this.headerButton);
    this.headerButton.classList.add('editor-control__dashboard__button');
    ...
    this.quoteButton.classList.add('editor-control__dashboard__button');
    ...
    this.textButton.classList.add('editor-control__dashboard__button');
    ...
    if (this.editor.options.uploadImage) {
      ...
      this.imageButton.classList.add('editor-control__dashboard__button');
    ...
    this.youtubeButton.classList.add('editor-control__dashboard__button')
